...
const items = [
  ...
  {
    title: "Jobba hos oss",
    text: "Vill du ha kul på jobbet, ha en bra balans mellan arbetsliv och privatliv och jobba hos en arbetsgivare som bryr sig, på riktigt. Då ska du söka dig till oss på Relinc.",
    button: "Jobba hos oss",
    icon: IconWork,
    color: "text-[#ff9aa2]",
    external: true,
    link: "https://relinc.se",
  },
  {
    title: "Support",
...
export const ContactCardsSection = () => {
  return (
    <section className="border-y border-white/20 py-20 md:py-24">
