        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          >
            <h2 className="mb-6 text-4xl font-bold md:text-5xl">
              Anpassade företagskläder
            </h2>

            <p className="mb-8 text-lg font-semibold leading-7 text-white/75">
              Vi hjälper företag att ta fram arbetskläder och profilkläder som
              passar både arbetsmiljö, varumärke och team. Behöver ni något
              utöver vårt standardsortiment kan vi även hjälpa till med
              specialbeställningar och skräddarsydda lösningar efter era
              önskemål.
            </p>
