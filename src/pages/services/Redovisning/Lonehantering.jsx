...
const Lonehantering = () => {
  return (
    <>
      <PageHero
        title="Lönehantering"
        subtitle="Professionell löneprocess som säkerställer compliance och transparens för ditt företag."
          ...
          <div className="grid grid-cols-2 gap-10">
            ...
            <div className="max-w-xl self-end">
              <h2 className="mb-6 text-4xl font-bold text-white">
                Lönehantering som gör skillnad
              </h2>

              <p className="mb-8 text-lg font-semibold leading-7 text-white">
                Vi erbjuder kvalificerad löneprocess för företag som vill ta
