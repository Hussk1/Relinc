  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Effektiv mobilanpassning för att förbättra din webbplats' prestanda på mobila enheter."
          ...
          <div className="grid grid-cols-2 gap-10">
            ...
            <div className="max-w-xl self-end">
              <h2 className="mb-6 text-4xl font-bold text-white">
                Mobilanpassning som gör skillnad
              </h2>

              <p className="mb-8 text-lg font-semibold leading-7 text-white">
                Vi erbjuder kvalificerad rådgivning för företag som vill ta
